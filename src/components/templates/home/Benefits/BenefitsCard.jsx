...
const BenefitsCard = ({ benefit, className }) => {
  return (
    ...
    >
      <div className='flex h-16 w-16 items-center justify-center rounded-full border-2 border-accent bg-background-light p-4 transition-all duration-300 ease-in group-hover:bg-gradient-to-tr group-hover:from-[#1EBF6E] group-hover:to-[#64F4AB] xs:h-20 xs:w-20 sm:h-16 sm:w-16 md:h-20 md:w-20 md:p-0 lg:h-24 lg:w-24 dark:bg-background-dark'>
        {benefit.icon}
      </div>
