...
const colors = {
  ...
  secondary: 'text-secondary border-secondary hover:bg-secondary hover:text-text-light',
  ...
  accent: 'text-accent border-accent hover:bg-accent hover:text-background-light',
...
const OutlineButton = ({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={`rounded-xl border-2 px-6 py-2 font-main font-medium transition-all duration-300 ease-in-out ${colorClasses} ${className}`}
    >
      {children}
    </button>
  );
