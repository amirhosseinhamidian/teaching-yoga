...
const CartModal = ({ onClose }) => {
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className='absolute left-14 top-14 w-fit rounded-xl bg-surface-light p-4 xs:w-[300px] sm:w-96 dark:bg-background-dark'>
        {isLoading ? (
          <div className='flex min-h-36 min-w-52 items-center justify-center sm:min-h-48 md:min-h-72'>
